...
#-------------------------------------------------------------------------------------------------------------------------------------------------
	...
	if save_fitrun:
		...
		which_fit, min_energy, max_energy, g1_guess, g2_guess, I0_guess, alpha_guess, break_guess_low, cut_guess,
